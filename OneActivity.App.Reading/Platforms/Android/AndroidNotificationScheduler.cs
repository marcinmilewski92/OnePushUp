...
public class AndroidNotificationScheduler : INotificationScheduler
{
        ...
        try
        {
            ...
            if (Build.VERSION.SdkInt >= BuildVersionCodes.O)
            {
                var channel = new NotificationChannel(
                    OneActivity.App.Reading.Platforms.Android.NotificationDisplayer.ChannelId,
            ...
            var notificationIntent = new Intent(context, typeof(OneActivity.App.Reading.MainActivity));
            ...
            var builder = new NotificationCompat.Builder(context, OneActivity.App.Reading.Platforms.Android.NotificationDisplayer.ChannelId)
        ...
        CreateAlarmIntents(Context context, TimeSpan time)
    {
        ...
        exactIntent.SetAction(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ActionDailyNotification);
        exactIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationId, 1);
        exactIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationTime, $"{calendar.Time}");
        exactIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraApproach, "exact");
        ...
        inexactIntent.SetAction(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ActionDailyNotification);
        inexactIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationId, 2);
        inexactIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationTime, $"{calendar.Time}");
        inexactIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraApproach, "inexact");
        ...
        repeatingIntent.SetAction(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ActionDailyNotification);
        repeatingIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationId, 3);
        repeatingIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationTime, $"{calendar.Time}");
        repeatingIntent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraApproach, "repeating");
    ...
    private void SetWindowAlarm(Context context, AlarmManager alarmManager, TimeSpan time, int minuteOffset, int requestCode)
    {
        try
        {
            ...
            intent.SetAction(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ActionDailyNotification);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationId, requestCode);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraWindowAlarm, true);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraMinuteOffset, minuteOffset);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraApproach, $"window_{minuteOffset}");
    ...
    private void SendTestNotificationDelayed(Context context, long delayMs)
    {
        ...
        {
            var intent = new Intent(context, Java.Lang.Class.FromType(typeof(NotificationReceiver)));
            intent.SetAction(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ActionTestNotificationAlarm);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationId, 999);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraTestNotification, true);
            intent.PutExtra(OneActivity.App.Reading.Platforms.Android.NotificationIntentConstants.ExtraNotificationTime, $"{DateTime.Now.AddMilliseconds(delayMs):yyyy-MM-dd HH:mm:ss}");
